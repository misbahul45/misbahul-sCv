...
const EssaiAboutMe = () => {
  return (
    <div>
     <h1 className="text-center lg:text-4xl md:text-3xl text-2xl font-semibold">About Me</h1>
      <br />
      <p className='text-center text-lg'>After finishing high school, I decided to take a gap year instead of going straight to college. During this time, I focused on learning web development starting with HTML. It was exciting to understand how websites are built and how content is structured online.
